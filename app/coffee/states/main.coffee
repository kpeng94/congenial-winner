...
class Main extends Phaser.State
  ...
  create: ->
    ...
    socket.on 'move', (data) ->
      ...
      playerSprite.body.velocity.x = -1 * yInput * Math.cos(playerSprite.rotation)
      playerSprite.body.velocity.y = -1 * yInput * Math.sin(playerSprite.rotation)

      playerSprite.body.velocity.y += xInput * Math.cos(playerSprite.rotation)
      playerSprite.body.velocity.x += -1 * xInput * Math.sin(playerSprite.rotation)
